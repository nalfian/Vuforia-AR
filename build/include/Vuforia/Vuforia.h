...
enum HINT {
     ...
     *  Default is: 1.
     *  \note This hint can only be set after the ObjectTracker has been initialized.
     */
    ...
    */
    ...
    /// Set Model Target tracking mode. (DEPRECATED)
    /**
     * \deprecated This hint has been deprecated. It will be removed in an
     * upcoming %Vuforia release. Please use ModelTarget::setTrackingMode() instead.
     * 
